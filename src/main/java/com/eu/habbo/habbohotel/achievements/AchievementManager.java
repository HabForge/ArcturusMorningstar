...
import com.eu.habbo.messages.outgoing.inventory.achievements.AchievementComposer;
...
import com.eu.habbo.messages.outgoing.notifications.HabboAchievementNotificationComposer;
...
import com.eu.habbo.messages.outgoing.talent.TalentLevelUpComposer;
...
public class AchievementManager {
    ...
    public static void progressAchievement(Habbo habbo, Achievement achievement, int amount) {
        ...
        if (newLevel == null ||
            ...
            habbo.getClient().sendResponse(new AchievementComposer(habbo, achievement));
            habbo.getClient().sendResponse(new HabboAchievementNotificationComposer(habbo, achievement));
