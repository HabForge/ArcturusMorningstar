...
import com.eu.habbo.messages.outgoing.room.furniture.CustomUserNotificationComposer;
...
public class InteractionHabboClubGate extends InteractionDefault implements ConditionalGate {
    ...
    public void onClick(GameClient client, Room room, Object[] objects) throws Exception {
        if (client != null) {
            if (this.canWalkOn(client.getHabbo().getRoomUnit(), room, null)) {
                ...
                client.sendResponse(new CustomUserNotificationComposer(CustomUserNotificationComposer.GATE_NO_HC));
            }
        }
    }
    ...
    public void onRejected(RoomUnit roomUnit, Room room, Object[] objects) {
        ...
        room.getHabbo(roomUnit).getClient().sendResponse(
                new CustomUserNotificationComposer(CustomUserNotificationComposer.GATE_NO_HC)
        );
    }
}
