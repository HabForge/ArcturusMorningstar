    ...
    public void handle() throws Exception {
        ...
        if (this.client.getHabbo().hasPermission(Permission.ACC_SUPPORTTOOL)) {
            ...
            if (habbo != null) {
                ...
                this.client.sendResponse(new IssueCloseNotificationComposer(Emulator.getTexts().getValue("generic.user.not_found").replace("%user%", Emulator.getConfig().getValue("hotel.player.name"))));
            }
        }
    }
}