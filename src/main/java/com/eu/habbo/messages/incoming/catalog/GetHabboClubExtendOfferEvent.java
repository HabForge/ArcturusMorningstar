...
public class GetHabboClubExtendOfferEvent extends MessageHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(GetHabboClubExtendOfferEvent.class);
