...
public class NewConsoleComposer extends MessageComposer {
    private final Message message;
    private final int toId;
    private final int fromId;

    public NewConsoleComposer(Message message) {
        this.message = message;
        this.toId = message.getFromId();
        this.fromId = message.getFromId();
    }

    public NewConsoleComposer(Message message, int toId, int fromId) {
        this.message = message;
        this.toId = toId;
        this.fromId = fromId;
    }
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.NewConsole);
