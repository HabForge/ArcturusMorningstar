...
public class GuildMembershipsComposer extends MessageComposer {
    private final THashSet<Guild> guilds;
    private final Habbo habbo;

    public GuildMembershipsComposer(THashSet<Guild> guilds, Habbo habbo) {
        this.guilds = guilds;
        this.habbo = habbo;
    }
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.GuildMemberships);
