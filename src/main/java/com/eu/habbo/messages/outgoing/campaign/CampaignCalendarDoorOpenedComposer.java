...
public class CampaignCalendarDoorOpenedComposer extends MessageComposer {
    public final boolean visible;
    public final CalendarRewardObject rewardObject;
    public final Habbo habbo;

    public CampaignCalendarDoorOpenedComposer(boolean visible, CalendarRewardObject rewardObject, Habbo habbo) {
