...
public class SlideObjectBundleRoomUnitComposer extends MessageComposer {
    private static final Logger LOGGER = LoggerFactory.getLogger(SlideObjectBundleRoomUnitComposer.class);
    ...
    public SlideObjectBundleRoomUnitComposer(RoomUnit roomUnit, HabboItem roller, RoomTile oldLocation, double oldZ, RoomTile newLocation, double newZ, Room room) {
    ...
    public SlideObjectBundleRoomUnitComposer(RoomUnit roomUnit, RoomTile newLocation, Room room) {
        this.roomUnit = roomUnit;
        this.roller = null;
