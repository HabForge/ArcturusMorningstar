...
public class SlideObjectBundleItemComposer extends MessageComposer {
    ...
    public SlideObjectBundleItemComposer(HabboItem item, HabboItem roller, RoomTile newLocation, double heightOffset, Room room) {
        this.item = item;
        this.roller = roller;
    ...
    public SlideObjectBundleItemComposer(HabboItem item, HabboItem roller, RoomTile oldLocation, double oldZ, RoomTile newLocation, double newZ, double heightOffset, Room room) {
        this.item = item;
        this.roller = roller;
    ...
    protected ServerMessage composeInternal() {
        ...
        this.response.init(Outgoing.SlideObjectBundle);
        ...
        if(this.oldLocation == null) {
            ...
            //this.room.sendComposer(new HeightMapUpdateComposer(oldX, oldY, this.room.getStackHeight(oldX, oldY, true)).compose());
            //
