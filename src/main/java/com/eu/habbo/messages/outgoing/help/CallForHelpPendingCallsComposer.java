...
public class CallForHelpPendingCallsComposer extends MessageComposer {
    private final List<ModToolIssue> pendingIssues;

    public CallForHelpPendingCallsComposer(List<ModToolIssue> issues) {
        this.pendingIssues = issues;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.CallForHelpPendingCalls);
