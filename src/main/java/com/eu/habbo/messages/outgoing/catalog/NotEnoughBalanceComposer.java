...
public class NotEnoughBalanceComposer extends MessageComposer {
    private final boolean isCredits;
    private final boolean isPixels;
    private final int pointsType;

    public NotEnoughBalanceComposer(boolean isCredits, boolean isPixels, int pointsType) {
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.NotEnoughBalance);
