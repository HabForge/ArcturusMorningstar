...
public class HabboAchievementNotificationComposer extends MessageComposer {
    private final Achievement achievement;
    private final Habbo habbo;

    public HabboAchievementNotificationComposer(Habbo habbo, Achievement achievement) {
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.HabboAchievementNotification);
