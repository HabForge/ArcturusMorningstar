...
public class ObjectAddComposer extends MessageComposer {
    private final HabboItem item;
    private final String itemOwnerName;

    public ObjectAddComposer(HabboItem item, String itemOwnerName) {
        this.item = item;
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.ObjectAdd);
