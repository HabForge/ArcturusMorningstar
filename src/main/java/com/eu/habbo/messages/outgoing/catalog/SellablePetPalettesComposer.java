...
public class SellablePetPalettesComposer extends MessageComposer {
    private final String petName;
    private final THashSet<PetRace> petRaces;

    public SellablePetPalettesComposer(String petName, THashSet<PetRace> petRaces) {
    ...
    protected ServerMessage composeInternal() {
        if (this.petRaces == null)
            return null;
        this.response.init(Outgoing.SellablePetPalettes);
