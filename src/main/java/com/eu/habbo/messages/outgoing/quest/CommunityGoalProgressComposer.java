...
public class CommunityGoalProgressComposer extends MessageComposer {
    ...
    public CommunityGoalProgressComposer(boolean achieved,
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.CommunityGoalProgress);
