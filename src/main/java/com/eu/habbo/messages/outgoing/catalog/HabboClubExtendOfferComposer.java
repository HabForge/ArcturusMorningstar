...
public class HabboClubExtendOfferComposer extends MessageComposer {
    ...
    public HabboClubExtendOfferComposer(Habbo habbo, ClubOffer offer, int normalCreditCost, int normalPointsCost, int pointsType, int daysRemaining) {
        this.habbo = habbo;
        this.offer = offer;
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.HabboClubExtendOffer);
