...
public class ForumDataComposer extends MessageComposer {
    private static final Logger LOGGER = LoggerFactory.getLogger(ForumDataComposer.class);

    public final Guild guild;
    public Habbo habbo;

    public ForumDataComposer(Guild guild, Habbo habbo) {
        this.guild = guild;
        this.habbo = habbo;
    }
    ...
    protected ServerMessage composeInternal() {
        ...
        try {
            this.response.init(Outgoing.ForumData);
