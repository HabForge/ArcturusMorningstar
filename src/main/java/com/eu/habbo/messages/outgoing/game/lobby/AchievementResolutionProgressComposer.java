...
public class AchievementResolutionProgressComposer extends MessageComposer {
    ...
    public AchievementResolutionProgressComposer(int stuffId, int achievementId, String achievementName, int currentProgress, int progressNeeded, int timeLeft) {
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.AchievementResolutionProgress);
