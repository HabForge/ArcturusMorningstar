...
public class ChatReviewSessionStartedComposer extends MessageComposer {
    private final GuardianTicket ticket;

    public ChatReviewSessionStartedComposer(GuardianTicket ticket) {
        this.ticket = ticket;
    }
    ...
    protected ServerMessage composeInternal() {
        ...
        this.response.init(Outgoing.ChatReviewSessionStarted);
