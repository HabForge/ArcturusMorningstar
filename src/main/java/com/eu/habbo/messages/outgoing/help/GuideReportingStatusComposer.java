...
public class GuideReportingStatusComposer extends MessageComposer {
    ...
    public GuideReportingStatusComposer(int errorCode, int errorCodeType) {
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.GuideReportingStatus);
