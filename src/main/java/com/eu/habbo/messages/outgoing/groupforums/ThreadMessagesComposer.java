...
public class ThreadMessagesComposer extends MessageComposer {
    private final int guildId;
    private final int threadId;
    private final int index;
    private final Collection<ForumThreadComment> guildForumCommentList;

    public ThreadMessagesComposer(int guildId, int threadId, int index, Collection<ForumThreadComment> guildForumCommentList) {
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.ThreadMessages);
