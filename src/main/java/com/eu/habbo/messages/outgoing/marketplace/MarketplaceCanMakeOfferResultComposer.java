...
public class MarketplaceCanMakeOfferResultComposer extends MessageComposer {
    ...
    public MarketplaceCanMakeOfferResultComposer(int errorCode, int valueA, int valueB) {
