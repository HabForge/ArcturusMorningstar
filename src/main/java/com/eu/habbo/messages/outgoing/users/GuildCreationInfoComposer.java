...
public class GuildCreationInfoComposer extends MessageComposer {
    private final THashSet<Room> rooms;

    public GuildCreationInfoComposer(THashSet<Room> rooms) {
        this.rooms = rooms;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.GuildCreationInfo);
