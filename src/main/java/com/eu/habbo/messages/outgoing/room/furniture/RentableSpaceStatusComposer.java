...
public class RentableSpaceStatusComposer extends MessageComposer {
    ...
    public RentableSpaceStatusComposer(Habbo habbo, HabboItem item) {
        this.habbo = habbo;
        this.item = item;
        this.errorCode = 0;
    }

    public RentableSpaceStatusComposer(Habbo habbo, HabboItem item, int errorCode) {
        this.habbo = habbo;
        this.item = item;
    ...
    protected ServerMessage composeInternal() {
        ...
        this.response.init(Outgoing.RentableSpaceStatus);
