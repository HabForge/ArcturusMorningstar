...
public class HabboGroupJoinFailedComposer extends MessageComposer {
    ...
    public HabboGroupJoinFailedComposer(int code) {
        this.code = code;
    }

    @Override
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.HabboGroupJoinFailed);
