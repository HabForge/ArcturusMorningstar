...
public class HabboGroupDetailsComposer extends MessageComposer {
    private final Guild guild;
    private final GameClient client;
    private final boolean newWindow;
    private final GuildMember member;

    public HabboGroupDetailsComposer(Guild guild, GameClient client, boolean newWindow, GuildMember member) {
        this.guild = guild;
        this.client = client;
