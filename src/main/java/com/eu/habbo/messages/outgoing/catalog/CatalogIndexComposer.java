...
public class CatalogIndexComposer extends MessageComposer {
    private static final Logger LOGGER = LoggerFactory.getLogger(CatalogIndexComposer.class);

    private final Habbo habbo;
    private final String mode;
    private final boolean hasPermission;

    public CatalogIndexComposer(Habbo habbo, String mode) {
        this.habbo = habbo;
        this.mode = mode;
    ...
    protected ServerMessage composeInternal() {
        try {
            ...
            this.response.init(Outgoing.CatalogIndex);
