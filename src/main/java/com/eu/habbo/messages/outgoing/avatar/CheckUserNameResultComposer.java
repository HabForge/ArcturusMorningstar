...
public class CheckUserNameResultComposer extends MessageComposer {
    ...
    public CheckUserNameResultComposer(int status, String name, List<String> suggestions) {
        this.status = status;
        this.name = name;
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.CheckUserNameResult);
