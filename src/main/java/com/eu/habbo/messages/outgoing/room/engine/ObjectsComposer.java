...
public class ObjectsComposer extends MessageComposer {
    private final TIntObjectMap<String> furniOwnerNames;
    private final THashSet<? extends HabboItem> items;

    public ObjectsComposer(TIntObjectMap<String> furniOwnerNames, THashSet<? extends HabboItem> items) {
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.Objects);
