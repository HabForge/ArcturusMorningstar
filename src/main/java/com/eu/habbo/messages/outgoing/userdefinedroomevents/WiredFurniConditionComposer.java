...
public class WiredFurniConditionComposer extends MessageComposer {
    private final InteractionWiredCondition condition;
    private final Room room;

    public WiredFurniConditionComposer(InteractionWiredCondition condition, Room room) {
    ...
    protected ServerMessage composeInternal() {
        this.response.init(Outgoing.WiredFurniCondition);
