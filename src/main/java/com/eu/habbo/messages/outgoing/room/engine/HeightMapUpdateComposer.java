...
public class HeightMapUpdateComposer extends MessageComposer {
    private int x;
    private int y;
    private short z;
    ...
    public HeightMapUpdateComposer(int x, int y, short z, double height) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.height = height;
    ...
    public HeightMapUpdateComposer(Room room, THashSet<RoomTile> updateTiles) {
    ...
    protected ServerMessage composeInternal() {
        ...
        if (this.updateTiles != null) {
            ...
            if(this.updateTiles.size() > 127) {
                ...
                this.room.sendComposer(new HeightMapUpdateComposer(this.room, updateTiles).compose());
