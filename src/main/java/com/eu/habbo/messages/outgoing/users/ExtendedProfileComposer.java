...
public class ExtendedProfileComposer extends MessageComposer {
    private static final Logger LOGGER = LoggerFactory.getLogger(ExtendedProfileComposer.class);

    private final HabboInfo habboInfo;
    private Habbo habbo;
    private GameClient viewer;

    public ExtendedProfileComposer(HabboInfo habboInfo, GameClient viewer) {
        this.habboInfo = habboInfo;
        this.viewer = viewer;
    }

    public ExtendedProfileComposer(Habbo habbo, GameClient viewer) {
        this.habbo = habbo;
    ...
    protected ServerMessage composeInternal() {
        ...
        this.response.init(Outgoing.ExtendedProfile);
